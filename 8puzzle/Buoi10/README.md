...
- Local Beam Search Lưu giữ K trạng thái tốt nhất tại mỗi bước duyệt thay vì chỉ 1 trạng thái. Thuật toán sẽ sinh ra tất cả các trạng thái kề từ K trạng thái này, sau đó lọc lại top K trạng thái có heuristic tốt nhất để đi tiếp, giúp tăng tỷ lệ tìm được đích và không bị kẹt.
...
Tại mục "Thuật toán", mở menu thả xuống và chọn thuật toán bạn muốn chạy (BFS, DFS, IDS, Greedy, UCS, A*, IDA*, Simple Hill Climbing, Steepest Ascent Hill Climbing, Stochastic Hill Climbing, Random Restart Hill Climbing hoặc Local Beam Search).
*(Lưu ý: Nếu bạn chọn thuật toán Local Beam Search, bạn có thể tùy chỉnh thông số ở ô "K (Beam Search)" bên cạnh).*
