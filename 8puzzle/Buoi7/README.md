...
Thuật toán: Chương trình cung cấp 3 bộ não đằng sau để giải quyết:
...
Tại mục "Thuật toán", mở menu thả xuống và chọn BFS, DFS hoặc IDS. (Bản cập nhật mới cho phép bạn chọn thêm cả Greedy và UCS).
